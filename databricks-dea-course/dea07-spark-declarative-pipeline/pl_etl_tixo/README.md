...
This folder defines all source code for the 'pl_etl_tixo' pipeline:
...
* Take a look at the sample under "sample_users_pl_etl_tixo.py" to get familiar with the syntax.
